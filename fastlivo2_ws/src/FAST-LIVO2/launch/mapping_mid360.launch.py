...
def generate_launch_description():
    ...
    # ================= 🔴 修改点 1：指向你刚才改好的配置文件 =================
    # 原来是 avia.yaml，改为 mid360.yaml
    avia_config_cmd = os.path.join(config_file_dir, "mid360.yaml")
    
    # 原来是 camera_pinhole.yaml，改为 camera_mid360.yaml
    ...
    return LaunchDescription([
        ...
        # ================= 🔴 修改点 3：注释掉 republish 节点 =================
        # 这个节点是用来解压数据集图片的，你是硬件直出 raw 图片，不需要这个！
        # 如果留着它，它会报错找不到 /left_camera/image
        # -------------------------------------------------------------
        # Node(
